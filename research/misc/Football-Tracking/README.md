# Football-Player-Tracki

## Products

### Stitched video
Video has been pre-calculated. It is located under "vid/OUTFILE-3.mp4". If you want to test the video stitching you can simply rename the files and the system will re calculate everything. It will take time.
