...
export default class VideoPlayer extends Component {
  ...
  formatTime(time = 0) {
    ...
    const formattedMinutes = '03';
    const formattedSeconds = '33';
      ...
      >
        <ImageBackground
          source={Expo.Asset.fromModule(
            require('./assets/img/top-vignette.png')
          )}
  ...
  renderBack() {
    return this.renderControl(
      <Image
        source={Expo.Asset.fromModule(require('./assets/img/back.png'))}
      ...
      <View style={styles.volume.container}>
        ...
        >
          <Image
            ...
            source={Expo.Asset.fromModule(require('./assets/img/volume.png'))}
          />
        </View>
      </View>
    );
  ...
  renderFullscreen() {
    let source =
      this.state.isFullscreen === true
        ? Expo.Asset.fromModule(require('./assets/img/shrink.png'))
        : Expo.Asset.fromModule(require('./assets/img/expand.png'));
    return this.renderControl(
      <Image source={source} />,
      this.methods.toggleFullscreen,
  ...
  renderPlayPause() {
    let source =
      this.state.paused === true
        ? Expo.Asset.fromModule(require('./assets/img/play.png'))
        : Expo.Asset.fromModule(require('./assets/img/pause.png'));
    return this.renderControl(
      <Image source={source} />,
    ...
    if (this.state.loading) {
      return (
        <View style={styles.loader.container}>
          <Animated.Image
            source={Expo.Asset.fromModule(
              require('./assets/img/loader-icon.png')
            )}
            style={[
              styles.loader.icon,
              {
    ...
    if (this.state.error) {
      return (
        <View style={styles.error.container}>
          <Image
            source={Expo.Asset.fromModule(
              require('./assets/img/error-icon.png')
            )}
